...
Begin VB.Form frmProjectTest 
   Caption         =   "Test DB Compact and Repair"
   ClientHeight    =   8400
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   9360
   Icon            =   "frmProjectTest.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   8400
   ScaleWidth      =   9360
   StartUpPosition =   2  'CenterScreen
   Begin VB.CommandButton cmdAbout 
      Caption         =   "Show About Form"
      Height          =   375
      Left            =   480
      TabIndex        =   21
      Top             =   5280
   ...
   Begin VB.Frame fraSQL 
      ...
      Begin VB.CommandButton cmdLookupSQL 
         Height          =   375
         Left            =   5820
         Picture         =   "frmProjectTest.frx":0442
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   630
         Width           =   435
      ...
      Begin VB.Label lblTest 
         Caption         =   "Enter path  to save SQL backup to (only path - no file name)"
         Height          =   255
         Index           =   2
         Left            =   240
         TabIndex        =   20
   ...
   Begin VB.Frame fraTestAccessDB 
      ...
      Begin VB.CommandButton cmdGetRestorePath 
         Height          =   375
         Left            =   5820
         Picture         =   "frmProjectTest.frx":058C
         Style           =   1  'Graphical
         TabIndex        =   22
         Top             =   3690
         Width           =   435
      ...
      Begin VB.CommandButton cmdLookup2 
         Height          =   375
         Left            =   5820
         Picture         =   "frmProjectTest.frx":06D6
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   2950
         Width           =   435
      ...
      Begin VB.CommandButton cmdGetFolder 
         Height          =   375
         Left            =   5820
         Picture         =   "frmProjectTest.frx":0820
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   1530
         Width           =   435
      ...
      Begin VB.CommandButton cmdLookup 
         Height          =   375
         Left            =   5820
         Picture         =   "frmProjectTest.frx":096A
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   630
         Width           =   435
   ...
   End
End
Attribute VB_Name = "frmProjectTest"
...
Private Sub cmdCopy_Click()
   ...
   If txtCopyDB.Text = "" Then
        txtCopyDB.SetFocus
        MsgBox "You must enter a path to copy the DB to before it can be copied!"
        Exit Sub
    End If
...
Private Sub cmdTest_Click()
   ...
   If strOriginalDB = "" Then Exit Sub
...
Private Sub cmdTestSQL_Click()
    ...
    If txtSQLBackup.Text = "" Then
        ...
        MsgBox "Enter a path to backup to"
        Exit Sub
    End If
    ...
    strUser = "Ron"
    strPWD = ""
    strDestPath = txtSQLBackup.Text
    strLocalCopy = "G:\Data\SQLBackup"
    
    bSuccess = m_objMaintain.BackupSQLDatabase(strDestPath, strSQLServer, strDB, strUser, strPWD, strLocalCopy, True)
    
    ' remote SQL server database
'    strSQLServer = "UTSTATUPC"
'    strDB = "Prosdlg"
'    strUser = "sa"
'    strPWD = "upc_530-xxsaxx7"
'    strDestPath = txtSQLBackup.Text
'    strLocalCopy = "C:\UPC"
'
'    bSuccess = m_objMaintain.BackupSQLDatabase(strDestPath, strSQLServer, strDB, strUser, strPWD, strLocalCopy, False)
'
End Sub
...
Private Sub cmdRestoreSQL_Click()
    ...
    strUser = "Ron"
    strPWD = ""
    strBackupFile = "G:\Data\SQLBackup\04182003Violations.bak"
    
'    strSQLServer = "(Local)"
'    strDB = "ConfManager1"
'    strUser = "RWeight"
'    strPWD = ""
'    strBackupFile = "C:\UPC\04152003UPCManager.bak"
'
    m_objMaintain.RestoreSQLDatabase strSQLServer, strUser, strPWD, strDB, strBackupFile, True, True
